...
$db = mysqli_connect("localhost","root","","ecom1");
...
function getPro(){
  global $db;
  $get_products = "select * from products order by 1 DESC LIMIT 0,8"; // total 8 product is showing
...
/// getPCats function Starts its function which dynamically print all the categories in sidebar ////
function getPCats(){
  global $db;
